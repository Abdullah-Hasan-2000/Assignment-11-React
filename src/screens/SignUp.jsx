                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" action="#">
                                ...
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Already have an account? <span onClick={()=> navigate('/login')} href="#" class="font-medium text-rose-600 hover:underline dark:text-rose-500 cursor-pointer">Sign in</span>
                                </p>
                            </form>
                        </div>
                    </div>
